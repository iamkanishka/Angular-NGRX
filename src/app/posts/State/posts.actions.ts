...
export const UPDATE_POSTS_SUCCESS_WITH_ENTITY = '[posts page] update posts success'
...
//Update for normal ngrx update action
export const updatePosts = createAction(UPDATE_POST, props<{post:Post}>())


//Update for  ngrx update with entity action
export const updatePostswithEntity = createAction(UPDATE_POST, props<{post:Post}>())

//Update for normal ngrx update action
export const updatePostsSuccess = createAction(UPDATE_POSTS_SUCCESS, props<{post:Post}>())

//Update for  ngrx with entity update action
export const updatePostsSuccesswithEntity = createAction(UPDATE_POSTS_SUCCESS_WITH_ENTITY, props<{post:Update<Post>}>())
